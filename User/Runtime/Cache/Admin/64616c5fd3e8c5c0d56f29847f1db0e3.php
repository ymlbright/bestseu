...
<div class="container">
<script>
	var LoginURL="<?php echo U('/Admin/Index/check');?>";
	var VCodeURL="<?php echo U('/Admin/Index/Verify');?>";
</script>
<div class"container-fluid row-fluid" >
	<div class="span11 offset1">
		<form class="form-horizontal" onsubmit="return Loginin();">
		  <div class="control-group">
		    <label class="control-label" for="terror"></label>
		    <div class="controls">
		      <p class="text-error" id="terror">后台登录</p>
		    </div>
		  </div>
		  <div class="control-group">
		    <label class="control-label" for="suser">用户名</label>
		    <div class="controls">
		  ...
		  <div class="control-group">
		    <label class="control-label" for="spwd">验证码</label>
		    <div class="controls">
		      <input type="text" id="vcode"> <img id="vcodeimg" src="<?php echo U('/Admin/Index/Verify');?>" onclick="return ChangeImg();"/>
		    </div>
		  </div>
		  <div class="control-group">
		    <div class="controls">
